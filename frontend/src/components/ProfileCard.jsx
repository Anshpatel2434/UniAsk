	...
	return (
		<div className="bg-gray-900 text-white p-6 md:p-8 rounded-xl shadow-lg w-full md:max-w-xs flex-shrink-0">
			<div className="flex flex-col items-center mb-6">
				<div className="w-20 h-20 md:w-32 md:h-32 rounded-full border-white border-2 p-2 flex items-center justify-center mb-4 bg-black text-white text-3xl md:text-5xl font-bold shadow-glow">
					{name.charAt(0)}
				</div>
